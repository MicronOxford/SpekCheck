...
function drawPlot(dye, excitation, filters, filterModes) {
    ...
    if (t_eff != null && e_eff != null && bright != null) {
       CHART.options.title = {display: true,
                               text: 'Efficency: ex ' + (100*e_eff).toFixed(1) + '%, tr ' + (100*t_eff).toFixed(1) + '%' + ', brightness ' + bright.toFixed(2),
                               fontSize: 24};
    } else if (t_eff != null && e_eff != null) {
        CHART.options.title = {display: true,
                               text: 'Efficency: ex ' + (100*e_eff).toFixed(1) + '%, tr ' + (100*t_eff).toFixed(1) + '%',
                               fontSize: 24};
    } else if (t_eff != null) {
        CHART.options.title = {display: true,
                               text: 'Efficency: tr ' + (100*t_eff).toFixed(1) + '%',
                               fontSize: 24};
    } else {
